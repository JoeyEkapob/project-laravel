    ...
    <nav id="sidebar" class="sidebar js-sidebar">
        <div class="sidebar-content js-simplebar">
            ...
            <ul class="sidebar-nav">
               ...
               @if($datauser['level'] != $datauser['maxlevel'] OR $datauser['level'] == 1 )
                <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    ...
                    <a data-bs-target="#report" data-bs-toggle="collapse" class="sidebar-link collapsed" aria-expanded="false">
                        <i class="align-middle" data-feather="clipboard"></i> 
                            <span class="align-middle"> รายงาน </span>
                    </a>

                    <ul id="report" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" style="">
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="report.php">&nbsp;&nbsp;&nbsp;--> รายงานหัวข้องาน</a>
                        </li>
                    </ul>
                
                    <ul id="report" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" style="">
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="reportuser.php">&nbsp;&nbsp;&nbsp;--> รายงานสมาชิก </a>
                        </li>
                    </ul>
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="user" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar" style="">
                        <li class="sidebar-item">
                            <a class="sidebar-link" href="user_list.php"> &nbsp;&nbsp;&nbsp;--> รายการสมาชิก </a>
                        </li>
                    </ul>
                </li>
                @endif
        ...
        <nav class="navbar navbar-expand navbar-light navbar-bg">
            ...
            <div class="navbar-collapse collapse">
                <ul class="navbar-nav navbar-align">
                    ...
                    <?php if($datauser['img'] !=""){?>
                        <img src="img/avatars/<?php echo $datauser['img'] ?>" class="avatar rounded-circle rounded me-1" alt="" > <span class="text-dark"> <?php echo $row['firstname'] . ' ' . $row['lastname'] ?></span>
                    <?php }else{?>
                        <img src="img/avatars/09.jpg" class="avatar rounded-circle rounded me-1" alt="" > <span class="text-dark"> <?php echo  $row['shortname_id'] . ' ' . $row['firstname'] . ' ' . $row['lastname'] ?></span>
                     <?php }?>
                    <div class="dropdown-menu dropdown-menu-end">
                       ...
                       {{-- <a class="dropdown-item" href="#"><i class="align-middle me-1" data-feather="pie-chart"></i> Analytics</a>
                        ...
                        <div class="dropdown-divider"></div>
                        <a class="dropdown-item logoutuser" href="{{route('logout')}}">ออกจากระบบ</a>
                    </div>
